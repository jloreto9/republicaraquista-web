    ...
    <div className="p-4 rounded-xl bg-[#0D152B] border border-[#1E2B4D] space-y-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-1.5 overflow-x-auto pb-1 sm:pb-0 scrollbar-none">
          <div className="flex items-center space-x-1 mr-1 sm:mr-2 text-xs text-slate-400 font-mono shrink-0">
          ...
          {phases.map((p) => {
            ...
            return (
              <button
                ...
                className={`px-2.5 sm:px-3 py-1.5 rounded-lg text-[11px] sm:text-xs font-medium transition-all shrink-0 whitespace-nowrap ${
                  isActive
        ...
        <div className="flex items-center space-x-2 w-full md:w-auto">
          ...
          <select
            ...
            className="flex-1 md:flex-none bg-[#070B19] text-xs font-semibold text-slate-200 border border-[#1E2B4D] rounded-lg px-3 py-1.5 focus:outline-none focus:border-[#FDB827]"
          >
