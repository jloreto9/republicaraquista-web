...
export function IndividualesView({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#1E2B4D] pb-4">
        <div className="flex items-center space-x-2">
          ...
          >
            ...
            <span>Fildeo & Defensa</span>
          </button>
        </div>

        {/* Badge Informativo */}
        <div className="flex items-center space-x-2 text-[11px] font-mono text-slate-400 bg-[#070B19] px-3 py-1.5 rounded-lg border border-[#1E2B4D]">
